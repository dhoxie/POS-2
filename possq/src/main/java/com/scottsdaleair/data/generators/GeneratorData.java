...
public final class GeneratorData {
    ...
    public static final String[] EMAIL_HOSTS = {
        "gmail.com",
        "yahoo.com",
        "comcast.net",
        "msn.com",
    ...
    public static final String[] PART_VENDORS = {
      "Visteon",
      "Tenneco",
      "Lear",
      "BorgWarner",
    ...
    public static final String[] MAKES = {
      "Cheverolet",
      "Honda",
      "Toyota",
      "Ford",
