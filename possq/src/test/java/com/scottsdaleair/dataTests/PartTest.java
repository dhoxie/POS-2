...
public class PartTest {
    ...
    /* did not pass. I think DB may not be running, or we may need to rewrite this test to pass - Daylyn(Tester)
    @Test
    ...
    */
    ...
    public void testToString() {
        String expected = "{" + " partID='" + part.getPartID()
                + "'" + ", vendor='" + part.getVendor()
                + "'" + ", onHand='" + part.getOnHand() + "'"
                + ", price='" + part.getPrice() + "'" + "}";
